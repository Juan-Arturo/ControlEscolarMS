        ...
        <div class="max-w-2xl mx-auto shadow-lg rounded-lg p-8">
            <form action="{{ route('materias.update', $materia->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nombre" name="nombre" value="{{ old('nombre', $materia->nombre) }}" class="w-full px-4 py-2 border border-[#902449] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#285C4D]" placeholder="Ingrese el nombre de la materia" required>
                </div>
