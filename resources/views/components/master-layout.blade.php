...
<body class="overflow-hidden">
    ...
    <div class="flex min-h-screen bg-gray-100 overflow-hidden">
        ...
        <!-- Sidebar: Ocultar en móviles y tabletas -->
        <aside class="w-72 bg-gradient-to-b from-[#621132] to-[#9D2449] text-white flex-shrink-0 shadow-2xl hidden md:block h-screen">
            @include('components.sidebar')
        </aside>
        ...
        <!-- Contenido principal: Habilitar desplazamiento solo en el contenido -->
        <main class="flex-grow overflow-auto max-h-screen ">
            {{ $slot }}
        </main>
